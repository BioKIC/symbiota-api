...
$params = [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Symbiota installation path
    |--------------------------------------------------------------------------
    |
    | Path to the base directory of the Symbiota installation to which the
    | API is coordinated. This path is used to obtain the database connection
    | variables used by the Symbiota portal
    |
    */

    'symbiota' => env('SYMBIOTA_PATH', ''),
...
if(isset($params['symbiota']) && $params['symbiota']){
    $symbBasePath = $params['symbiota'];
